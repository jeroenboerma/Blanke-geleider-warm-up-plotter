...
#Define component
def Component():
    Material = "Al. alloy"     #Choose "Copper", "Aluminium", "Al. alloy"
...
def component_parameters(Shape, Core, rho0, epsilon):
    ...
    if Shape == "Cylindrical":
        if Core == "Solid":
            ...
            Dh = 120*(1/1000)            #Outer diameter
            WD = 15*(1/1000)            #Wall thickness                                [m]
...
def Wheather(Material, Painted):
    #Weather conditions
    #phis = 900         #Solar flux density                                 [W/m2]
